                                            ...
                                            <div class="players" id="player1-container  vidDiv">
                                                ...
                                                <div class="media-wrapper">
                                                    <video id="player1" width="300" height="380" style="width:100%;"
                                                           poster="<?php echo $image; ?>" preload="none" controls
                                                ...
                                                <div class="row ry">
                                                    <div class="col-sm-6">
                                                        <h5 class=""><?php echo $title; ?> <span
                                                                    class="specialT">- <?php echo $initial; ?> <?php echo $fname; ?> (<?php echo $ministry; ?>)</span>
                                                        </h5><br/>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <ul class="social-icons-ql">
                                                            ...
                                                            <li><a href="#"><i class="fa fa-align-justify"></i> Save
                                                                </a></li>
                                                ...
                                                <div class="media td">
                                                    ...
                                                    <a href="play.php?id=<?php echo $message_id; ?>">
                                                        <div class="media-body">
                                                            ...
                                                            <p class="mp"><?php echo $fname; ?>
                                                                <br/><?php echo $views; ?> views
                                                                . <?php echo $newdate; ?></p>
                                                        </div>
                                                    </a>
                                                </div>
