...
<div class="respectMArgin">
    <div class="">
        ...
        <div class="row">
            ...
            $condi = "messages.category_id=category.category_id AND messages.user_id=users.user_id AND category.category_id='$cat' ";
            ...
            if ($total < 1) {
                ...
                $data = "messages.message_id,messages.user_id,messages.category_id,messages.title,messages.file,messages.image,messages.type,messages.sys_cat,
															...
															";
                $condition = " messages.category_id=category.category_id AND messages.user_id=users.user_id  AND category.category_id='$cat'
            ...
            <div class="page-pagi">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php
                        if ($page_cur > 1) {
                            echo '<li class="page-item"><a class="page-link" href="categ.php?page=' . ($page_cur - 1) . '&&name=LISTING" ><i class="fa fa-angle-double-left"></i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i < $total_page; $i++) {
                            if ($page_cur == $i) {
                                ...
                                echo '  <li class="page-item"><a class="page-link" href="categ.php?page=' . $i . '&&name=LISTING"  >' . $i . ' </a></li>';
                            }
                        }
                        if ($page_cur < $total_page) {
                            echo ' <li class="page-item">
	<a class="page-link" href="categ.php?page=' . ($page_cur + 1) . '&&name=LISTING" > <i class="fa fa-angle-double-right"></i></a></li>';
                        } else {
