...
<div class="respectMArgin">
    <div class="">
        ...
        <div class="row">
            ...
            $condi = "messages.category_id=category.category_id AND messages.user_id=users.user_id AND messages.type='free' ";
            ...
            if ($total < 1) {
                ...
                $data = "messages.message_id,messages.user_id,messages.category_id,messages.title,messages.file,messages.image,messages.type,messages.sys_cat,
															...
															";
                $condition = " messages.category_id=category.category_id AND messages.user_id=users.user_id  AND messages.type='free'
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 pud">
                        <div class="card area text-center">
                            <a href="play.php?id=<?php echo $message_id; ?>">
                                <div class="maske">
                                    <img src="../<?php echo $image; ?>" alt="Avatar" class="Overlayimage1"
                                         style="width:100%">
                                    <span class="duration"><?php echo $category; ?></span>
                                    <div class="middle">
                            ...
                            <div class="card-body par innerlink">
                                <h5 class="card-title st" title="<?php echo $title; ?>"><?php echo $title; ?></h5></p>
                                <p class=" syt"> <?php echo $fname; ?> <br/><span class="yui"><?php echo $views; ?> views . <?php echo $newdate; ?></span>
                                </p>
            ...
            <div class="page-pagi">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php
                        if ($page_cur > 1) {
                            echo '<li class="page-item"><a class="page-link" href="freebies.php?page=' . ($page_cur - 1) . '&&name=LISTING" ><i class="fa fa-angle-double-left"></i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i < $total_page; $i++) {
                            if ($page_cur == $i) {
                                ...
                                echo '  <li class="page-item"><a class="page-link" href="freebies.php?page=' . $i . '&&name=LISTING"  >' . $i . ' </a></li>';
                            }
                        }
                        if ($page_cur < $total_page) {
                            echo ' <li class="page-item">
	<a class="page-link" href="freebies.php?page=' . ($page_cur + 1) . '&&name=LISTING" > <i class="fa fa-angle-double-right"></i></a></li>';
                        } else {
