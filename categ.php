<?php include('include/index_header.php'); ?>
                    ...
                    <div class="page-pagi">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <?php
                                if ($page_cur > 1) {
                                    echo '<li class="page-item"><a class="page-link" href="categ.php?page=' . ($page_cur - 1) . '&&name=LISTING" ><i class="fa fa-prev"></i> Previous</a></li>';
                                } else {
	...
	<a class="page-link" href="categ.php?page=' . ($page_cur + 1) . '&&name=LISTING" >NEXT <i class="pe-7s-next"></i></a></li>';
                                } else {
                                    echo '<li class="page-item disabled active">  <span class="page-link">Next</span></li>';
                                }
                                ?>
                            </ul>
                        </nav>
